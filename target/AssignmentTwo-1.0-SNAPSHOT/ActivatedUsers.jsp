...
<div class="container">
    <div class="row marginTop">
        ...
        <c:if test="${fn:length(activatedUsers) > 0}">
            <br><h1>List of all users that are activated (<c:out value="${fn:length(activatedUsers)}"/>)</h1>
            <table class="table marginTop">
                ...
                <c:forEach items="${activatedUsers}" var="user">
                    <tr class="table-active">
                        ...
                        <td><a href="<c:url value="SuspendUserServlet?userID=${user.id}"/>" class="btn btn-danger">Suspend</a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
